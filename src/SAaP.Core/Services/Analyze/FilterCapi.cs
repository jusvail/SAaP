...
public class FilterCapi : FilterBase
{
	public FilterCapi(Condition condition) : base(condition)
	{
		AsyncFilter = true;
	}
	...
	public override async Task<bool> FilterAsync(IList<OriginalData> originalDatas)
	{
		...
		var capiNow = Convert.ToDouble(executed[45]); // 总市值
